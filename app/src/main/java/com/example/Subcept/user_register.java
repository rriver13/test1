...
//This registers the user to the Firebase Database
                    FirebaseDatabase.getInstance().getReference("Users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if(task.isSuccessful()){
                                Toast.makeText(com.example.Subcept.user_register.this, "This User Has Been Registered", Toast.LENGTH_LONG).show();

                            }else {
                                Toast.makeText(com.example.Subcept.user_register.this, "Failed to Register the User. Try Again!", Toast.LENGTH_LONG).show();
                            }
