...
//
//public class Subscription_Section extends Fragment {
//    private FireStoreDatabase FDB = null;
//
...
//
//    final ArrayList<BecomesEmptyListener> listeners = new ArrayList<BecomesEmptyListener> ();
//    final ArrayList<OnSubscriptionClickListener> subscriptionClickListeners = new ArrayList<OnSubscriptionClickListener> ();
//
...
//
//        FDB = new FireStoreDatabase((Edit_SubscriptionActivity) getActivity());
//        FDB.setOnDataChanged(new FireStoreDatabase.DataChangeListener(){
//            @Override
...
//            int total_payment = 12;
//            String payment = decimalFormat.format(FDB.getTotalPayment(total_payment));
...
//
//            View[] subscriptionViews = convertSubscriptionsToViews(FDB.getSubscriptions());
//
//            if (typeOfChange == -1) {
//                fillSubscriptionsInActivity(subscriptionViews);
//            }
//            else if(typeOfChange == FDB.REMOVED){
...
//                    }
//                }
//            }else if(typeOfChange == FDB.INSERTED){
//                subscriptionsContainer.addView(subscriptionViews[index], 0);
//            }else if(typeOfChange == FDB.REPLACED){
//                subscriptionsContainer.removeViewAt(index);
...
//            final View newView = subscriptions[i].getView((new_subscription_Activity) context, fontAwesome);
//
...
//                    int index = subscriptionsContainer.indexOfChild(view);
//                    Subscriptions subscription = FDB.getSubscriptions()[index];
//
